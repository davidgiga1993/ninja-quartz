...
interface NinjaQuartzUtil
{
	 ...
	 * @throws SchedulerException as thrown by the Scheduler
	 */
	Collection<Scheduler> getAllSchedulers() throws SchedulerException;

	/**
	 * @param schedulerName the name of the scheduler to get
	 * @return the {@link Scheduler} with the given name.
	 * @throws SchedulerException as thrown by the Scheduler
	 */
	Scheduler getSchedulerByName(String schedulerName) throws SchedulerException;
	 ...
	 * @param jobGroup the group name of the job
	 ...
	 * @throws SchedulerException as thrown by the Scheduler
	 */
	Collection<Trigger> getTriggersOfJob(String jobName, String jobGroup) throws SchedulerException;
